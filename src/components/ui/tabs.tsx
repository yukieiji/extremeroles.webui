	...
	return (
		<TabsPrimitive.Tab
			...
			className={cn(
				...
				"before:absolute before:inset-x-[10%] before:bottom-0 before:h-0.5 before:bg-[var(--tab-color)] before:opacity-0 before:transition-opacity group-data-[variant=default]/tabs-list:data-active:before:opacity-100",
