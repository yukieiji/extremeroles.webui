...
export function RightSidePanelBody({ children }: RightSidePanelBodyProps) {
	...
	return (
		<div className="h-full flex-1 min-w-0 bg-n4-bg-components border-l border-n2-border-strong shadow-2xl relative">
			{children}
			<div className="flex flex-col h-full">
				<div className="flex flex-col p-4 border-b border-n3-border-weak gap-2">
