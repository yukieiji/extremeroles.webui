...
export default function NeutralColors() {
  ...
  return (
    <div className="p-4 space-y-16" style={{ backgroundColor: NEUTRAL_COLORS.neutral1.hex }}>
      <div>
        ...
        <div className="grid grid-cols-1 gap-4">
          {colors.map((color) => (
            <div
              ...
              style={{ borderColor: NEUTRAL_COLORS.neutral4.hex, backgroundColor: NEUTRAL_COLORS.neutral1.hex }}
            >
              <div
      ...
      <section className="space-y-12">
        ...
        <div className="space-y-16">
          ...
          <div className="space-y-4">
            <h4 className={cn("text-sm font-medium opacity-50 uppercase tracking-wider", BASIC_TEXT_COLOR.textSecondary)}>Surface & Card (Unified Lv1 BG)</h4>
            <div
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="py-0.5 transition-colors"
                ...
                <div className="flex items-stretch" style={{ paddingLeft: getIndentation(0) }}>
                  ...
                  <div className="flex-1 flex items-center justify-between pr-4 py-2">
                    <span className={cn("text-sm font-bold", BASIC_TEXT_COLOR.textPrimary)}>アコーディオン項目 (Lv0)</span>
                    <span className={cn("text-xs", BASIC_TEXT_COLOR.textTertiary)}>w-8 Leading</span>
                  </div>
                </div>
              </div>
              ...
              {/* Divider (Lv5) */}
              <div className="px-4"><div style={{ height: '1px', backgroundColor: NEUTRAL_COLORS.neutral5.hex }} /></div>
              ...
              {/* Divider (Lv4) */}
              <div style={{ paddingLeft: '4rem', paddingRight: '1rem' }}><div style={{ height: '1px', backgroundColor: NEUTRAL_COLORS.neutral4.hex }} /></div>
            ...
            <p className={cn("text-xs mt-2", BASIC_TEXT_COLOR.textTertiary)}>
          ...
          <div className="space-y-4">
            <h4 className={cn("text-sm font-medium opacity-50 uppercase tracking-wider", BASIC_TEXT_COLOR.textSecondary)}>Border Samples (Lv4-6)</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 rounded border" style={{ borderColor: NEUTRAL_COLORS.neutral4.hex, backgroundColor: NEUTRAL_COLORS.neutral1.hex }}>
                <div className={cn("text-xs mb-2 font-mono", BASIC_TEXT_COLOR.textSecondary)}>Level 4: Separator</div>
                <div className="h-1 bg-gray-100 w-full" style={{ backgroundColor: NEUTRAL_COLORS.neutral4.hex }} />
              </div>
