...
import { buildSearchItems, globalSearchItems, auOptionMetaData, exrOptionMetaData } from "@/logics/api";
import { ExRTabId, UniqueOptionId, OptionValueType } from "@/type";
...
describe("buildSearchItems", () => {
    ...
    it("should populate search items from Au metadata", () => {
        ...
        expect(globalSearchItems).toContainEqual(expect.objectContaining({
            tearm: "Au Category",
